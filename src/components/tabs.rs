...
pub fn Tabs(content: TabProps) -> Element {
    rsx!(
        div { class: "tabs rounded-none mt-5 tabs-box justify-center w-[100%]",
            input {
                "aria-label": "new",
                name: "my_tabs_1",
                checked: true,
            ...
            div { class: "tab-content w-full mt-1", {content.tab_content_1} }
            input {
                name: "my_tabs_1",
                r#type: "radio",
                "aria-label": "saved",
            ...
            div { class: "tab-content w-full mt-5", {content.tab_content_2} }
        }
        Export {}
        Settings {}
    )
