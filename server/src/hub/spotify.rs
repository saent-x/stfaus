...
use crate::models::{AppEngineError, LLMResult, SearchAgent, Song};
...
impl SpotifyAgent {
    pub async fn init() -> Result<Self, AppEngineError> {
        ...
        client
            .request_token()
            .await
            .map_err(|err| AppEngineError::SearchAgentError(err.to_string()))?;
